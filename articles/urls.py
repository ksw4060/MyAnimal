...
urlpatterns = [
    ...
    path('list/<int:user_id>/',views.ArticlesListView.as_view(), name = 'article_list'), # /articles/<int:article_id>/list
    path('received/hearts/<int:user_id>/',views.ReceivedHeartsView.as_view(), name = 'receive_hearts'), # /articles/<int:article_id>/list
]
