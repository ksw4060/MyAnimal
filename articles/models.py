...
class Articles(models.Model):
    ...
    bookmarks = models.ManyToManyField(Users, blank=True, related_name='bookmarks')
...
class Comments(models.Model):
    ...
    comment_updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)  # 수정시각, 최초 글 작성시 디폴트를 None 으로, 수정시에 수정 시각 업데이트
